...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("fwe" "few" nil :count 0)
    ("gabi" "Gabriella" nil :count 1)
    ("garantee" "guarantee" nil :count 0)
    ("gaurd" "guard" nil :count 0)
    ("gcha" "Gaël chamoulaud <gchamoul@redhat.com>" nil :count 1)
    ...
    ("tv" "tripleo-validations" nil :count 0)
