...
(doom! :input
       ...
       (corfu +orderless +icon +minibuffer)
       ...
       (:if IS-LINUX (tty +osc))                ; improve the terminal Emacs experience
       ...
       (python +lsp +pyenv +tree-sitter +peek +pyright +cpython) ; beautiful is better than ugly
